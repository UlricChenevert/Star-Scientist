...
import { template_to_star, sync_local_storage_to_container, sync_container_to_local_storage } from './input_manipulation.js';

import { random_gradient_vector_grid, get_noise } from './noise.js'
...
window.onload = (e) => {
    ...
    local_view_model.star.subscribe(() => { // Update call
